...
def main(**kwargs):
    ...
    # parser.add_argument('--dataset', type=str, default='PeMS_08', help='Dataset name.')
    ...
    save_path = 'output/' + config['start_up']['model_name'] + "_" + dataset_name + ".pt"             # the best mymodel
    save_path_resume = 'output/' + config['start_up']['model_name'] + "_" + dataset_name + "_resume.pt"      # the resume mymodel
...
# ========================== load dataset, adjacent matrix, node embeddings ====================== #
    ...
    if dataset_name == 'PEMS04' or dataset_name == 'PeMS_08':  # traffic flow
...
# ============================= Model and Trainer ============================= #
    ...
    # training init: resume mymodel & load parameters
...
# =============================================================== Training ================================================================= #
    if mode != 'test':
        for epoch in range(resume_epoch + 1, optim_args['epochs']):
            ...
            print("optim_args['epochs']", optim_args['epochs'])
            # train a epoch
