...
class TrainLogger():
    ...
    - print all mymodel    hyperparameter setting
    - save all the python file of mymodel
    ...
    def __init__(self, model_name, dataset):
        ...
        cur_time = cur_time.replace(":", "-")
        # mkdir
        print('path + cur_time', path + cur_time)
    ...
    def print_model_args(self, model_args, ban=[]):
        self.__print(model_args, note='mymodel args', ban=ban)
