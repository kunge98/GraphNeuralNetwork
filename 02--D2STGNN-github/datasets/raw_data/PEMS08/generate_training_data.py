...
def generate_train_val_test(args):
    ...
    pickle.dump(_max, open("datasets/PeMS_08/max.pkl", 'wb'))
    pickle.dump(_min, open("datasets/PeMS_08/min.pkl", 'wb'))
...
if __name__ == "__main__":
    ...
    dataset        = "PeMS_08"    # PEMS or METR
    output_dir  = 'datasets/PeMS_08'
    traffic_df_filename = 'datasets/raw_data/PeMS_08/PeMS_08.npz'
