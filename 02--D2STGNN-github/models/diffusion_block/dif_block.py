...
class DifBlock(nn.Module):
    ...
    def forward(self, history_data, gated_history_data, dynamic_graph, static_graph):
        """Diffusion block, containing the diffusion mymodel, forecast branch, backcast branch, and the residual decomposition link.
        ...
        Returns:
            torch.Tensor: the output after the decoupling mechanism (backcast branch and the residual link), which should be fed to the inherent mymodel.
